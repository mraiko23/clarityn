...
// Middleware: Only allow access from Telegram WebApp or with valid Telegram login
function telegramOnly(req, res, next) {
  // For demo: allow all, but in prod check req.headers['user-agent'] or use Telegram WebApp
  next();
}
